  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <Container>
      <div class="py-12 max-w-4xl mx-auto">
        ...
        <!-- Post Content -->
        <article v-else-if="post" class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 md:p-12">
          <!-- Header -->
          <header class="mb-8">
            <div class="mb-4">
              <span
            ...
            <p v-if="post.excerpt" class="text-xl text-gray-600 dark:text-gray-400 mb-4">
              {{ post.excerpt }}
            </p>
