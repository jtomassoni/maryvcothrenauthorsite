    ...
    <Container>
      <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-12">
          <h1
            class="text-4xl lg:text-5xl font-serif font-bold gradient-text mb-6"
          >
            Contact
          </h1>
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-4">
              <div class="bg-gray-50 rounded-lg p-4">
                ...
                <p class="text-gray-600 text-sm">
                  Book clubs, writing workshops, and literary events
                </p>
              </div>
              ...
              <div class="bg-gray-50 rounded-lg p-4">
                ...
                <p class="text-gray-600 text-sm">
                  Literary projects, anthologies, and creative partnerships
                </p>
              </div>
              ...
              <div class="bg-gray-50 rounded-lg p-4">
                ...
                <p class="text-gray-600 text-sm">
                  Interviews, features, and press opportunities
                </p>
              </div>
            </div>
            ...
            <div class="bg-primary-50 rounded-lg p-6">
              ...
              <p class="text-gray-600 text-sm mb-4">
                Join my mailing list for the latest news, events, and exclusive
                content.
              </p>
              <router-link
                to="/#contact"
