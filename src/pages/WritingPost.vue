    ...
    <Container class="relative z-10">
      <div class="py-16 max-w-5xl mx-auto">
        ...
        <nav class="mb-8" aria-label="Breadcrumb">
          <ol class="flex items-center space-x-2 text-sm text-stone-600 dark:text-stone-400 font-serif">
            <li>
              <router-link
                to="/"
            ...
            <li class="text-stone-900 dark:text-stone-100 font-medium" aria-current="page">
        ...
        <div v-if="loading" class="text-center py-16">
          <p class="text-stone-600 dark:text-stone-400 font-serif italic">Loading writing...</p>
        </div>
        ...
        <!-- Writing Content -->
        <article v-else-if="writing" class="bg-white/70 dark:bg-stone-900/70 backdrop-blur-md border border-stone-200/70 dark:border-stone-800/70 shadow-2xl rounded-2xl overflow-hidden">
          <!-- Gradient accent bar -->
          <div class="h-2 bg-gradient-to-r from-amber-400 via-orange-400 to-rose-400 dark:from-amber-500 dark:via-orange-500 dark:to-rose-500"></div>
          
          <div class="p-10 md:p-16">
            <!-- Header -->
            <header class="mb-12 text-center border-b border-stone-300/70 dark:border-stone-700/70 pb-8">
            <div class="mb-6">
              <span
            ...
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-serif text-stone-900 dark:text-stone-100 mb-6 leading-tight tracking-tight">
              {{ writing.title }}
            </h1>
            <p v-if="writing.excerpt" class="text-xl md:text-2xl text-stone-700 dark:text-stone-300 mb-6 font-light italic leading-relaxed">
              {{ writing.excerpt }}
            </p>
            <p class="text-sm text-stone-500 dark:text-stone-500 font-serif italic">
              {{ formatDate(writing.publishedAt) }}
            </p>
          </header>
          
          <div class="h-px bg-gradient-to-r from-transparent via-stone-300 dark:via-stone-700 to-transparent my-10"></div>
          ...
          <div class="prose prose-lg md:prose-xl dark:prose-invert max-w-none prose-headings:font-serif prose-headings:text-stone-900 prose-headings:dark:text-stone-100 prose-p:text-stone-800 prose-p:dark:text-stone-200 prose-p:leading-relaxed prose-p:font-light prose-strong:text-stone-900 prose-strong:dark:text-stone-100 prose-strong:font-normal prose-a:text-stone-900 prose-a:dark:text-stone-100 prose-a:border-b prose-a:border-stone-400 prose-a:dark:border-stone-600 prose-a:no-underline hover:prose-a:border-stone-600 dark:hover:prose-a:border-stone-400 prose-blockquote:border-l-stone-400 prose-blockquote:dark:border-l-stone-600 prose-blockquote:text-stone-700 prose-blockquote:dark:text-stone-300 prose-blockquote:italic prose-blockquote:font-light">
            ...
            <!-- Footer -->
            <footer class="mt-16 pt-8 border-t border-stone-300/70 dark:border-stone-700/70">
              <router-link
                to="/writings"
