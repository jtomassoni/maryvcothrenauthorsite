<template>
  <header
    class="bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm shadow-sm dark:shadow-gray-800/50 sticky top-0 z-50 transition-all duration-300"
  >
    <Container>
      <div class="flex justify-between items-center py-6">
        ...
        <router-link
          to="/"
          s
          class="text-2xl font-serif font-bold gradient-text dark:bg-gradient-to-r dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 dark:bg-clip-text dark:text-transparent focus-ring rounded transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/20 dark:hover:shadow-blue-400/30"
          @click="scrollToTop"
        >
          Mary V. Cothren
        </router-link>
