<template>
  <div
    class="bg-white dark:bg-gray-800 rounded-lg shadow-lg dark:shadow-gray-900/50 p-8 border dark:border-gray-700"
  >
    <div class="text-center mb-8">
      <h2
        class="text-2xl lg:text-3xl font-serif font-bold gradient-text dark:bg-gradient-to-r dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 dark:bg-clip-text dark:text-transparent mb-4"
      >
        {{ title }}
      </h2>
...
withDefaults(defineProps<Props>(), {
  ...
  description:
    'Get updates on new releases, events, and exclusive content delivered to your inbox.',
